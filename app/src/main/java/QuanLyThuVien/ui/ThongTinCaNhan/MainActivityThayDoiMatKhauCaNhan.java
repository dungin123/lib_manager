...
import SplashScreen.MainActivitySplashScreen;

public class MainActivityThayDoiMatKhauCaNhan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_thay_doi_mat_khau_ca_nhan);
            ...
            public void onClick(View v) {
                ...
                if (ed_Pass.length() == 0) {
                    ...
                    if (password.equals(passwordXacNhan)) {
                        ...
                        intent = new Intent(MainActivityThayDoiMatKhauCaNhan.this, MainActivitySplashScreen.class);
